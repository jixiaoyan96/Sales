...
class ShiftForm extends CFormModel
{
    public $id;
    public $username;
    public $visit_dt;
        ...
        return array(
            'A'=>array(
                ...
                'items'=>array(
                    ...
                    'A5'=>array('name'=>Yii::t('sales','皂液机'),'type'=>'qty','eol'=>true),
            ...
            'C'=>array(
                ...
                'items'=>array(
                    ...
                    'C5'=>array('name'=>Yii::t('sales','租灭蝇灯'),'type'=>'checkbox','eol'=>true),
...
//		$rtn = array(''=>Yii::t('misc','-- None --'));
    ...
    public function groupShift($arr){
        $suffix = Yii::app()->params['envSuffix'];
        $name=$arr['visit_shift'];
        $sale=$arr['id'];

        $sql="select user_id from hr$suffix.hr_binding where employee_id='".$name."'";
