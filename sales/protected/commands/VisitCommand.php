...
class VisitCommand extends CConsoleCommand
{
    public function run()
    {
        ...
        where  c.system_id='sal' and c.a_read_write like '%HK01%' and  d.status='A' and a.city='$k' and   e.visit_dt >= '" . $arr['start_dt'] . "'and e.visit_dt <= '" . $arr['end_dt'] . "' a.staff_status =0";
                    ...
                    if (!empty($people)) {
                        ...
                        $last_names = array_column($arr_email,'last_name');
                        array_multisort($last_names,SORT_DESC,$arr_email);
