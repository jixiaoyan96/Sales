<tr class='clickable-row' data-href='<?php echo $this->getLink('HK01', 'salesorder/edit', 'salesorder/view', array('index'=>$this->record['id']));?>'>
	<td><?php echo $this->drawEditButton('HK01', 'salesorder/edit', 'salesorder/view', array('index'=>$this->record['id'])); ?></td>
