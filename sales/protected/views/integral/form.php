	...
	<div class="box box-info">
		<div class="box-body">
            ...
            <table class="tftable" border="1">
                ...
                <?php foreach ($model['cust_type_name']['yushou'] as $arr) {?>
                    <tr><td><?php echo $arr['cust_type_name'];?></td><td> 其他</td><td>  </td><td> <?php echo IntegralForm::getConditionsName($arr['conditions']);?></td><td> <?php echo $arr['fraction'];?></td><td> <?php echo $arr['number'];?></td><td> <?php echo $arr['sum'];?></td><td> <?php if($arr['toplimit']!=0){echo $arr['toplimit']."个月" ;}?></td></tr>
                <?php }?>
...
<!--                <tr><td> 销售拜访表平均每天20条</td><td> 其他</td><td> </td><td> 每月</td><td> --><?php //echo $model['cust_type_name']['baifang20']['fraction'];?><!--</td><td> --><?php //echo $model['cust_type_name']['baifang20']['number'];?><!--</td><td> --><?php //echo $model['cust_type_name']['baifang20']['sum'];?><!--</td><td> </td></tr>-->
                <?php foreach ($model['cust_type_name']['baifang'] as $arr) {?>
                    <tr><td><?php echo $arr['cust_type_name'];?></td><td> 其他</td><td>  </td><td> <?php echo IntegralForm::getConditionsName($arr['conditions']);?></td><td> <?php echo $arr['fraction'];?></td><td> <?php echo $arr['number'];?></td><td> <?php echo $arr['sum'];?></td><td> </td></tr>
                <?php }?>
