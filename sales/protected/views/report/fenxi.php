        ...
        <div class="box-body">
            ...
            <div>
                ...
                <table class="tftable3" border="1">
                    ...
                    <tr><th rowspan="5" width="100">客服类别（非餐饮）</th><th>4S店</th><td><?php echo $arr['sisdian'];?>个</td><th>健身会所</th><td><?php echo $arr['jianshenhuisuo'];?>个</td><th>房地产</th><td><?php echo $arr['fangdican'];?>个</td><th>美容/发馆</th><td><?php echo $arr['meifa'];?>个</td><th width="70">银行</th width="70"><td><?php echo $arr['yinhang'];?>个</td><th width="70">俱乐部</th><td><?php echo $arr['julebu'];?>个</td><th width="70">培训机构</th><td><?php echo $arr['peixunjigou'];?>个</td> </tr>
