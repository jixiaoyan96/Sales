...
<?php endif ?>
	...
	<td <?php echo $cls_str;?>><?php echo $this->record['sup_score']; ?></td>
	<td <?php echo $cls_str;?>><?php echo $this->record['mgr_score']; ?></td>
	<td <?php echo $cls_str;?>><?php echo $this->record['dir_score']; ?></td>
	<td>
		<?php 
