...
<section class="content">
    <div class="box">
        <div class="box-body">
            ...
            <div class="btn-group" role="group">
                <?php
                if (Yii::app()->user->validRWFunction('HK01'))
                    echo TbHtml::button('<span class="fa fa-file-o"></span> '.Yii::t('misc','lookThrough video list'), array(
    ...
    <?php $this->widget('ext.layout.ListPageWidget', array(
        'title'=>Yii::t('quiz','sellers video List'),
        'model'=>$model,
        'viewhdr'=>'//Salesvideo/_sellerslisthdr',
        'viewdtl'=>'//Salesvideo/_sellerslistdtl',
        'gridsize'=>'24',
        'height'=>'600',
        'search'=>array(
            'sellers_name',
