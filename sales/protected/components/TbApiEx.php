...
class TbApiEx extends TbApi {
    ...
    public function registerAllScripts()
    {
		...
		$cs->scriptMap = array(
            'font-awesome.min.css'=>Yii::app()->baseUrl.'/css/font-awesome.min.css',
            'ionicons.min.css'=>Yii::app()->baseUrl.'/css/ionicons.min.css',
            ...
            'moment.min.js'=>Yii::app()->baseUrl.'/js/moment.min.js',
