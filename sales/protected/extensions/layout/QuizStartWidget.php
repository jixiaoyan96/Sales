...
class QuizStartWidget extends CWidget
{
    public $model;
    public $title;
    public $gridsize;
    ...
    protected function fieldSearch(){
       $start= $this->model->startDate;
        ...
        $layout='';
        $layout.="&nbsp;&nbsp;<input type='hidden' value='$baseUrl$link' id='urlSearch'><span><a href='#'>开始日期</a><input value='$start' id='startDate' class='form-control' name='startDate' /></span>";
        $layout.="&nbsp;&nbsp;<span><a href='#'>截至日期</a><input value='$end' id='endDate' name='endDate'  class='form-control'/></span>";
        $layout.="&nbsp;&nbsp;<span><a href='#'>员工名</a><input type='text' value='$name' id='employeeName' name='employeeName'  class='form-control'/></span>";
        $layout.="&nbsp;&nbsp;<span><a href='#'>部曲选择</a>
<select class='form-control' name='video_step' id='video_step' >
<option value='$step' selected='selected'>第.$step.部</option>
<option value='0'>部曲选择</option>
<option value='1'>第一部</option>
<option value='2'>第二部</option>
<option value='3'>第三部</option>
<option value='4'>第四部</option>
<option value='5'>第五部</option>
</select>
</span>
";
        $layout .="<button class='fa fa-search form-control' id='salesVideo'>".Yii::t('misc','Search')."</button>
        <script>
var startDate=$('#startDate').val();
var endDate=$('#endDate').val();
var employeeName=$('#employeeName').val();
var video_step=$('#video_step').val();
var url=$('#urlSearch').val();
$('#salesVideo').click(function(){
console.log(startDate);
console.log(endDate);
console.log(employeeName);
window.location.href=url+'?startDate='+startDate+'&endDate='+endDate+'&employeeName='+employeeName+'&video_step='+video_step;
});
</script>";
        return $layout;
    }
