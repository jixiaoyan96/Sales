	...
	$.fn.cxScroll=function(settings){
		...
		scroller.init=function(){
			...
			if(settings.prevBtn&&!scroller.dom.prevBtn.length){
				scroller.dom.prevBtn=$("<a class='prev'></a><span class='arrow arrow-left'></span>",{"class":"prev"}).prependTo(obj);
			};
			if(settings.nextBtn&&!scroller.dom.nextBtn.length){
				scroller.dom.nextBtn=$("<a class='next'></a><span class='arrow arrow-right'></span>",{"class":"next"}).prependTo(obj);
			};
